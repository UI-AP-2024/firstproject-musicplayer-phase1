...
public class PodcasterViewer {
    private static PodcasterViewer podcasterViewer;

    public PodcasterViewer() {
    }

    public static PodcasterViewer getPodcasterViewer() {
        if (podcasterViewer == null)
            podcasterViewer=new PodcasterViewer();
        return podcasterViewer;
    }
