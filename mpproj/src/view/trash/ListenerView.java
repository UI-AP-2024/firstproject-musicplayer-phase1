...
public class ListenerView {
    ...
    public void ListenerView() throws ParseException{
        ...
        while (true) {
            ...
            switch (spltCmd[0]) {
                ...
                ListenerController.getListenerController().getPremium(30,PremuimAcc.ONE_MONTH.getMoney());
                    break;
                case 60:
                ListenerController.getListenerController().getPremium(60,PremuimAcc.TWO_MONTH.getMoney());
                    break;
                case 180:
                ListenerController.getListenerController().getPremium(180,PremuimAcc.THREE_MONTH.getMoney());
                    break;
                default:
                    break;
                }
