    ...
    public void ListenerView(String[] spltCmd) throws ParseException {
        ...
        switch (spltCmd[0]) {
            ...
            case "Filter":
                ...
                break;
            case "Add":
                txt = ListenerController.getListenerController().addAudioToPlaylist(spltCmd[1],
                        Long.parseLong(spltCmd[2]));
                System.out.println(txt);
            ...
            case "GetPremium":
                ...
                switch (packag) {
                    case 30:
                        txt = ListenerController.getListenerController().getPremium(30,
                                PremuimAcc.ONE_MONTH.getMoney());
                        System.out.println(txt);
                        break;
                    case 60:
                        txt = ListenerController.getListenerController().getPremium(60,
                                PremuimAcc.TWO_MONTH.getMoney());
                        System.out.println(txt);
                        break;
                    case 180:
                        txt = ListenerController.getListenerController().getPremium(180,
                                PremuimAcc.THREE_MONTH.getMoney());
                        System.out.println(txt);
                        break;
                    default:
                        break;
